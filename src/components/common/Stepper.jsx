...
const STEP_COLORS = ['#FFD43B', '#4D7CFE', '#FF72B6', '#5BCB77'];
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: 'var(--surface, #ffffff)', color: 'var(--muted, #6f6f6a)' },
          active: { scale: 1.15, backgroundColor: color, color: '#111111' },
          complete: { scale: 1, backgroundColor: color, color: '#111111' }
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: 'var(--text, #111111)' }
  };
